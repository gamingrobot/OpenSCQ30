...
use crate::{
    api::device,
    devices::soundcore::{
        a3947::{packets::A3947SoundModesUpdatePacket, structures::A3947SoundModes},
        common::{
...
impl SoundModesPacketHandler {
    pub const COMMAND: Command = A3947SoundModesUpdatePacket::COMMAND;
}

#[async_trait]
impl<T> PacketHandler<T> for SoundModesPacketHandler
where
    T: Has<A3947SoundModes> + Send + Sync,
{
    async fn handle_packet(
        ...
        let packet: A3947SoundModesUpdatePacket = packet.try_to_packet()?;
