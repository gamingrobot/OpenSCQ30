...
pub struct A3947SoundModesUpdatePacket {
    pub sound_modes: A3947SoundModes,
}

impl A3947SoundModesUpdatePacket {
    pub const COMMAND: Command = Command([0x06, 0x01]);
}

impl FromPacketBody for A3947SoundModesUpdatePacket {
    ...
    fn take<'a, E: ParseError<&'a [u8]> + ContextError<&'a [u8]>>(
        ...
        // offset 9
        context(
            "A3947SoundModesUpdatePacket",
            all_consuming(map(A3947SoundModes::take, |sound_modes| Self {
                sound_modes,
            })),
        )
...
//     use crate::devices::soundcore::{
//         a3947::{
//             packets::A3947SoundModesUpdatePacket,
//             structures::{A3947NoiseCancelingMode, AdaptiveNoiseCanceling, ManualNoiseCanceling},
//         },
//         common::{
...
//         A3947SoundModesUpdatePacket::take::<VerboseError<_>>(&packet.body)
...
//         ];
//         let (_, packet) = packet::Inbound::take::<VerboseError<_>>(input).unwrap();
//         let sound_modes = A3947SoundModesUpdatePacket::take::<VerboseError<_>>(&packet.body)
//             .unwrap()
//             .1
//             .sound_modes;
//         assert_eq!(AmbientSoundMode::Normal, sound_modes.ambient_sound_mode);
//         assert_eq!(
//             A3947NoiseCancelingMode::Manual,
